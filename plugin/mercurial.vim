...
autocmd BufEnter * command! -buffer -nargs=* Hgpull :call mercurial#hg('pull', <f-args>)
autocmd BufEnter * command! -buffer -nargs=* Hgpush :call mercurial#hg('push', <f-args>)

autocmd BufEnter * command! -buffer Hgstatus :call mercurial#status()

autocmd BufEnter * command! -buffer -nargs=* -complete=file HgaddPath :call mercurial#add(<f-args>)
autocmd BufEnter * command! -buffer -nargs=* -complete=file HgforgetPath :call mercurial#forget(<f-args>)
autocmd BufEnter * command! -buffer -nargs=* -complete=file HgremovePath :call mercurial#forget(<f-args>)
autocmd BufEnter * command! -buffer -nargs=* -complete=file HgrevertPath :call mercurial#revert(<f-args>)
autocmd BufEnter * command! -buffer -nargs=* -complete=file HgrenamePath :call mercurial#rename(<f-args>)

autocmd BufEnter * command! -buffer -nargs=* Hgadd :call mercurial#add(expand('%'), <f-args>)
autocmd BufEnter * command! -buffer -nargs=* Hgforget :call mercurial#forget(expand('%'), <f-args>)
autocmd BufEnter * command! -buffer -nargs=* Hgremove :call mercurial#forget(expand('%'), <f-args>)
autocmd BufEnter * command! -buffer -nargs=* Hgrevert :call mercurial#revert(expand('%'), <f-args>)
autocmd BufEnter * command! -buffer -nargs=* -complete=file Hgrename :call mercurial#rename(expand('%'), <f-args>)
